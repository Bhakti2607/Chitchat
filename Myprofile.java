            ...
            public void onClick(View v) {
                ...
                user.updateEmail(email).addOnSuccessListener( new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        ...
                        user.put("uname",profileFullName.getText().toString());
                        user.put("uemail",email);
                        user.put("uphone",profilePhone.getText().toString());
                       // DocumentReference docRef = fStore.collection("users").document(user.getUid());
                       // Map<String,Object> edited = new HashMap<>();
                        //edited.put("email",email);
                        //edited.put("uname",profileFullName.getText().toString());
                        //edited.put("uphone",profilePhone.getText().toString());
                        ...
                        dr.setValue (user).addOnSuccessListener(new OnSuccessListener<Void>() {
                            @Override
                            public void onSuccess(Void aVoid) {
                                Log.d(TAG,"User registration is done for:"+id);
                            }
                        });
